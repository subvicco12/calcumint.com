...
export async function SiteHeader() {
  ...
  return <header className="site-header"><div className="container header-inner">
    ...
    <nav className="nav nav-desktop" aria-label="Primary navigation">
      <Link href="/calculators">Calculators</Link><Link href="/ai">AI Finder</Link><Link href="/pricing">Pricing</Link>
    ...
    <div className="nav-compact">
      ...
      <details className="nav-menu"><summary aria-label="Open navigation menu"><span aria-hidden="true">☰</span><span className="menu-label">Menu</span></summary><nav aria-label="Compact navigation"><Link href="/calculators">Calculators</Link><Link href="/ai">AI Finder</Link><Link href="/pricing">Pricing</Link><Link href="/business">Business Tools</Link>{user ? <Link href="/account">Account</Link> : <Link href="/login?mode=signup">Sign up free</Link>}</nav></details>
    </div>
  </div></header>;
}
