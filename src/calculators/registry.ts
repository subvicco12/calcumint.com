...
const financeDefinitions=[compoundInterestCalculator,loanPaymentCalculator,loanAnalysisCalculator,loanRefinanceCalculator,loanPrepaymentCalculator,loanComparisonCalculator,loanAffordabilityCalculator,debtPayoffCalculator,creditCardPayoffCalculator,termDepositCalculator,recurringDepositCalculator,sipCalculator,stepUpSipCalculator,investmentMathCalculator,swpCalculator,rateConversionCalculator,savingsGoalCalculator,roiCalculator,netWorthCalculator,inflationCalculator,simpleInterestCalculator,emergencyFundCalculator].map((definition)=>applyFinanceReleaseCertification(eraseCalculatorTypes(definition)));
