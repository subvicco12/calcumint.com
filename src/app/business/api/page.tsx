...
import { createBusinessApiKey, revokeBusinessApiKey } from "./actions";
  ...
  return (
    <section className="container page-top business-page">
      <div className="section-heading">
        <div><span className="eyebrow">Business automation</span><h1>API keys & usage</h1><p className="hero-copy">Connect CalcuMint to your software, n8n, Make, Zapier, Airtable, CRM or internal workflow.</p></div>
      ...
      <article className="card section">
        ...
        <p className="muted">Authenticate with <code>Authorization: Bearer &lt;api-key&gt;</code>. API keys are scope-limited, rate-limited and monthly-quota metered.</p>
      </article>
    </section>
  );
}
