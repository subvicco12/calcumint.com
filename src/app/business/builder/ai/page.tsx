...
export default async function BuilderAiPage() {
  ...
  return <section className="container page-top business-page"><div className="section-heading"><div><span className="eyebrow">Business Builder AI</span><h1>Turn requirements into a validated draft.</h1><p className="hero-copy">AI proposes structure and formulas; CalcuMint's deterministic schema and formula engine remain authoritative.</p></div><Link className="button secondary" href="/business/builder">Back to builder</Link></div><BuilderAiAssistant /></section>;
}
